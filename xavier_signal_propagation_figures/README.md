...
Run the file [make_figs.sh](make_figs.sh) - it will make xavier figures [preln_forward.png](preln_forward.png), [preln_backward.png](preln_backward.png) and [postln_backward.png](postln_backward.png) and exit.
