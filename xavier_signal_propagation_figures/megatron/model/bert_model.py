...
class BertLMHead(MegatronModule):
    ...
    def __init__(self, mpu_vocab_size, hidden_size, init_method,
        ...
        if args.xavier_flag_sigma:
            xavier_flag_sigma_lm_head_linear = 1.0/math.sqrt(args.hidden_size) # 0.044
        else:
            xavier_flag_sigma_lm_head_linear = 0.02
        self.dense = get_linear_layer(hidden_size, hidden_size, init_method(xavier_flag_sigma_lm_head_linear))
    ...
    def __init__(self,
        ...
        if self.post_process:
            ...
            if self.add_binary_head:
                if args.xavier_flag_sigma:
                    xavier_flag_sigma_binary_head = math.sqrt(2.0/(args.hidden_size+2)) # 0.044
                else:
                    xavier_flag_sigma_binary_head = 0.02
                self.binary_head = get_linear_layer(args.hidden_size, 2,
                                                    init_method(xavier_flag_sigma_binary_head))
