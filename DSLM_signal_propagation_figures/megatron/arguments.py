...
def _add_initialization_args(parser):
    ...
    group.add_argument('--moment-control-sigma', action='store_true',
                       help='Enable moment control sigma')
    group.add_argument('--moment-control-lambda-beta', action='store_true',
                       help='Enable moment control dynamic scaling')
    group.add_argument('--moment-control-lambda-sq', type=float, default=0.995,
                       help='Enable moment control initial scaling')
    group.add_argument('--moment-control-beta-sq', type=float, default=0.005,
                       help='Enable moment control initial scaling')
